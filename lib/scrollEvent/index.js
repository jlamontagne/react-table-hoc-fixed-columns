  ...
  function (_React$Component) {
    ...
    _createClass(ReactTableFixedColumns, [{
      ...
      value: function updatePos() {
        ...
        [].forEach.call(target.querySelectorAll(".".concat(this.fixedLeftClassName)), function (td) {
          td.style.transform = "translate3d(".concat(_this2.nextTranslateLeftX, "px, 0, 0)");
        });
        [].forEach.call(target.querySelectorAll(".".concat(this.fixedRightClassName)), function (td) {
